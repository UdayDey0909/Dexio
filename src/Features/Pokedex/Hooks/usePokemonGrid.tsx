// hooks/usePokemonGrid.ts - Optimized version for infinite scroll
   ...
   const fetchPokemon = useCallback(
      async (isRefresh = false, isLoadMore = false) => {
         try {
            ...
            if (!(await pokemonService.checkConnection())) {
            ...
            const pokemonIds = pokemonListResponse.results.map(
               (pokemon, index) => currentOffset + index + 1
            );
